...
namespace Celeste.Mod.Grabhelper {
    ...
    [CustomEntity("Grabhelper/GrabBerry")]
    [Tracked]
	[RegisterStrawberry(true, true)]
    public class GrabBerry : Entity, IStrawberry {


		public GrabBerry(EntityData data, Vector2 offset, EntityID gid) : base(data.Position + offset)
		{
